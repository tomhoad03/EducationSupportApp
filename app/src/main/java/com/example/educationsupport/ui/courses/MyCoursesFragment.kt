...
import com.example.educationsupport.databinding.FragmentMycoursesBinding
        ...
        menuHost.addMenuProvider(object : MenuProvider {
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                return when (menuItem.itemId) {
                    R.id.action_profile -> {
                        findNavController().navigate(R.id.action_navigation_mycoursesFragment_to_profileFragment)
                        true
                    }
    ...
    private fun createAddNewCourseButton() {
        if (user.educator) {
            ...
            binding.newCourseButton.setOnClickListener {
                ...
                dialog.findViewById<Button>(R.id.add_course_button).setOnClickListener {
                ...
                dialog.findViewById<Button>(R.id.cancel_course_button).setOnClickListener {
                    dialog.dismiss()
                }
                dialog.show()
            }
                    ...
                    EducationSupportComposeTheme {
                        Surface(color = MaterialTheme.colors.background) {
                            LazyColumnClickable(coursesMap) {
                                val bundle = Bundle()
                                bundle.putString("courseId", it.first)
                                bundle.putSerializable("course", it.second)
                                bundle.putBoolean("educator", user.educator)
                                findNavController().navigate(
                                    R.id.action_navigation_mycoursesFragment_to_navigation_courseFragment,
                                    bundle
                                )
                            }
                        }
    ...
    private fun signOut() {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton("Sign Out") { _, _ ->
                auth.signOut()
                findNavController().navigate(R.id.action_navigation_mycoursesFragment_to_navigation_loginFragment)
            }
            .show()
    }
